...
def unique_houses(filename):
    ...
    for info in cohort_data:
        line = info.rstrip()
        word = line.split("|")
        first_name, last_name, house_name, advisor, cohort_graduation = word
        if house_name:
...
def sort_by_cohort(filename):
    ...
    for line_info in cohort_data:
        line = line_info.rstrip()
        word = line.split("|")
        first_name, last_name, house_name, teacher, cohort_graduation = word
        student_name = first_name + " " + last_name
        if cohort_graduation == "Winter 2016":
            winter_16.append(student_name)
        elif cohort_graduation == "Spring 2016":
            spring_16.append(student_name)
        elif cohort_graduation == "Summer 2016":
            summer_16.append(student_name)
        elif cohort_graduation == "Fall 2015":
            fall_15.append(student_name)
        elif cohort_graduation == "G":
...
def all_students_tuple_list(filename):
    ...
    for line in cohort_data:
        ...
        first_name, last_name, house_name, advisor, cohort_graduation = word
        if house_name:
            student_list.append((first_name + " " + last_name, house_name, advisor, cohort_graduation))
...
def find_cohort_by_student_name(student_list):
    ...
    """
    question = raw_input("Please input first and last name of student")

    for student_info in student_list:
        student_name, house, advisor, cohort = student_info
        if question == student_name:
            print "%s was in the %s cohort" % (student_name, cohort)


    print "Who are you looking for? Tom Riddle"
...
def find_name_duplicates(filename):
    ...
    for line in cohort_data:
        ...
        #     continue
        # else:
        #     duplicate_names.add(old_last_name)
...
# unique_houses("cohort_data.txt")
all_students_tuple_list = all_students_tuple_list("cohort_data.txt")
# find_cohort_by_student_name(all_students_tuple_list)
